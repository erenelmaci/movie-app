...
import { createUserWithEmail, signInWithGoogle } from "../auth/firebase"
      ...
      <div className="d-flex justify-content-center mt-4">
        <form className="form_container">
          ...
          <div className="input_container">
            <label className="input_label" htmlFor="first_name">
              First Name
            </label>
            <div className="icon">
              <SlUser />
          ...
          <div className="input_container">
            <label className="input_label" htmlFor="last_name">
              Last Name
            </label>
            <div className="icon">
              <SlUserFollowing />
